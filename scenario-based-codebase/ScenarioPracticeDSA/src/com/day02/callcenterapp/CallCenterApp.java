...
public class CallCenterApp {
	...
	public static void main(String[] args) {
		...
		// Incoming calls
		callCenter.receiveCall(new Call("C101", "Abh", false, "Internet not working"));
		callCenter.receiveCall(new Call("C205", "Akshat", true, "Billing dispute"));
		callCenter.receiveCall(new Call("C101", "Abhi", false, "Slow speed again"));
		callCenter.receiveCall(new Call("C308", "Abhishek ", false, "New connection request"));
		callCenter.receiveCall(new Call("C205", "Akshat ", true, "Urgent - port out issue"));
		callCenter.receiveCall(new Call("C412", " Patel", false, "Recharge problem"));
